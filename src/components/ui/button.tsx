...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md hover:bg-primary/90 hover:shadow-lg shadow-purple-500/20",
        purple:
          "bg-[#7C3AED] text-white hover:bg-[#6D28D9] shadow-md hover:shadow-purple-500/30",
        accent:
          "bg-[#F97316] text-white hover:bg-[#EA580C] shadow-md hover:shadow-orange-500/30",
        destructive:
        ...
        glass: "glass-panel text-foreground hover:bg-white/80 dark:hover:bg-zinc-800/80 shadow-sm",
      },
      size: {
